...
class ParserTest {
	...
	@Test
	void testParseLevel1Custom() throws IOException {
		AST sut = parseTestFile("level1-custom.icss");
		AST exp = Fixtures.customUncheckedLevel1();
		assertEquals(exp, sut);
	}
	...
	@Test
	void testParseLevel2Custom() throws IOException {
		AST sut = parseTestFile("level2-custom.icss");
		AST exp = Fixtures.customUncheckedLevel2();
		assertEquals(exp,sut);
	}
	@Test
